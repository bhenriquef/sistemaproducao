...
else //se estiver logado permite ver a tela
{
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                if($num > 0){
                    echo "
                            ...
                            <div class=\"card mb-4 shadow-sm\">
                              ...
                              <div class=\"card-body\">
                                ...
                                <ul class=\"list-unstyled mt-3 mb-4\">
                                    ...
                                    echo "</li>";
                                    $resposta = impComentario($peca['id_peca']);
                                    //chama a function para imprimir os tipos de usuario em um <option> (/Controller/impressao.php)
                                    while ($comentario = $resposta->fetch_assoc()){
                                        echo "<li><b>Comentario da Avalição: </b></li><li>". $comentario['comentario']." </li>";
                                    }
                                    echo "
                       ...
                       <label>Comentario</label>
                        <label>Detalhes</label>
                             <form method='POST' action='ampliacao.php?i=0&pagina=0'> 
                                ...
                                <div class='row justify-content-center'>
                                    <div class='col-md-8'>
                                        ...
                                        echo "</select>
                                               ...
                                               <label>Data Saida</label><input class='form-control' type='date' id='datasaida' name='datasaida' required><br>
                                               <input class='form-control btn btn-outline-success' type='submit' id='btnampliacao' name='btnampliacao' value='Proxima Etapa'>
                                              </form>
                                    </div>
                                </div>
                      </div>
                    ...
                    echo "<h2 class='text-center'>Não tem nada para ser ampliado</h2>";
                }
                ?>
            </div>
        </div>
    ...
    <form action="ampliacao.php" method="GET">
        <nav>
            <ul class="pagination justify-content-center">
                <li class="page-item">
                    <?php
                    if($pagina != 0){
                        echo "<a class='page-link' href='ampliacao.php?pagina=0&i=0'><span aria-hidden='true'>&laquo</span></a>";
                    }
                    else{
                ...
                <li class="page-item">
                    <?php
                    if($pagina != 0){
                        echo "<a class='page-link' href='ampliacao.php?pagina=".($pagina-1)."&i=".($i-1)."'> < </a>";
                    }
                    else{
                ...
                <li class="page-item">
                    <?php
                    if($pagina+1 < $num_total){
                        echo "<a class='page-link' href='ampliacao.php?pagina=".(($num_paginas-1)*1)."&i=".($num_paginas-1)."'><span aria-hidden='true'>&raquo</span></a>";
                    }
                    else{
